...
from mmseg.datasets.nkb_robosegment_small import NkbRobosegmentSmallDataset
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='422images_training', seg_map_path='422annotations_training_10cats'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path='107images_validation', seg_map_path='107annotations_validation_10cats'),
